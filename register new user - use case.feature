Feature: Student attempts to register a new user profile in the system
...
3. The original form does not have a field for password - the system relies upon the user logging in with a username and a password